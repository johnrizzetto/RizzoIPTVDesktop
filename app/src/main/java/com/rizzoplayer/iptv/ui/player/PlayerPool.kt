...
object PlayerPool {
     ...
     *
     * maxBufferMs (12 s): keeps the viewer close to the live edge while leaving
     *   headroom for the player to fill during good network windows without adding
     *   noticeable latency beyond the natural ~3–5 s live edge offset.
     *
